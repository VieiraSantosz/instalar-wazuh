...
**2. Usando script:** Acesse a pasta [script](https://github.com/VieiraSantosz/wazuh/tree/main/script), faça o download do script install_wazuh.sh, e siga as orientações de uso.
